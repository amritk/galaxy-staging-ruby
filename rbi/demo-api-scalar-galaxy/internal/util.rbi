  ...
  module Internal
    ...
    module Util
      ...
      class << self
        ...
        sig do
          params(url: T.any(URI::Generic, String)).returns(
            DemoApiScalarGalaxy::Internal::Util::ParsedUri
          )
        end
        def parse_uri(url)
        end
        ...
        sig do
          params(
            parsed: DemoApiScalarGalaxy::Internal::Util::ParsedUri
          ).returns(URI::Generic)
        end
        ...
        sig do
          params(
            lhs: DemoApiScalarGalaxy::Internal::Util::ParsedUri,
            rhs: DemoApiScalarGalaxy::Internal::Util::ParsedUri
          ).returns(URI::Generic)
        end
      ...
      class << self
        # @api private
        sig do
          params(query: DemoApiScalarGalaxy::Internal::AnyHash).returns(
            DemoApiScalarGalaxy::Internal::AnyHash
          )
        end
        ...
        sig do
          params(
            collection: DemoApiScalarGalaxy::Internal::AnyHash,
            key: String,
            element: T.anything
          ).void
        end
      ...
      class << self
        ...
        sig do
          params(lines: T::Enumerable[String]).returns(
            T::Enumerable[DemoApiScalarGalaxy::Internal::Util::ServerSentEvent]
          )
        end
        ...
        class << self
          ...
          sig do
            params(
              type:
                T.any(
                  DemoApiScalarGalaxy::Internal::Util::SorbetRuntimeSupport,
                  T.anything
                )
            ).returns(T.anything)
          end
