    ...
    module Type
      ...
      module Converter
        ...
        Input =
          T.type_alias do
            T.any(
              DemoApiScalarGalaxy::Internal::Type::Converter,
              T::Class[T.anything]
            )
          end
        ...
        sig do
          overridable
            .params(
              value: T.anything,
              state: DemoApiScalarGalaxy::Internal::Type::Converter::CoerceState
            )
            .returns(T.anything)
        end
        ...
        class << self
          ...
          sig do
            params(
              target: DemoApiScalarGalaxy::Internal::Type::Converter::Input,
              value: T.anything,
              state: DemoApiScalarGalaxy::Internal::Type::Converter::CoerceState
            ).returns(T.anything)
          end
          def self.coerce(
            ...
            state: DemoApiScalarGalaxy::Internal::Type::Converter.new_coerce_state
          )
          end
