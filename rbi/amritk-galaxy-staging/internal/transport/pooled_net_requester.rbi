      ...
      class PooledNetRequester
        ...
        class << self
          ...
          sig do
            params(
              request:
                DemoApiScalarGalaxy::Internal::Transport::PooledNetRequester::Request,
        ...
        def self.new(
          size: DemoApiScalarGalaxy::Internal::Transport::PooledNetRequester::DEFAULT_MAX_CONNECTIONS
        )
        end
      end
    end
