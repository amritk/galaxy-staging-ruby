...
client = DemoApiScalarGalaxy::Client.new(max_retries: 2, timeout: 30)
...
cases = [
  {
    ...
    run: -> { client.planets.create({id: 1, name: "Mars", type: "terrestrial"}) }
  },
  {
    operation: "create",
    method: "POST",
  ...
  },
  {
    ...
    path: "/planets/{planetId}",
    label: "required params",
    run: -> { client.planets.update(1, {id: 1, name: "Mars", type: "terrestrial"}) }
  },
  {
    operation: "update",
    method: "PUT",
  ...
  },
  {
    ...
    method: "GET",
    path: "/planets",
    run: -> { client.planets.list({limit: 10, offset: 0}) }
  },
  {
    operation: "delete",
    method: "DELETE",
  ...
  },
  {
    ...
    label: "required params",
    run: -> { client.planets.upload_image(1) }
  },
  {
    operation: "uploadImage",
    method: "POST",
    path: "/planets/{planetId}/image",
    label: "all params",
    run: -> { client.planets.upload_image(1, {image: "@mars.jpg"}) }
  },
  {
    operation: "create",
    method: "POST",
    ...
    label: "required params",
    run: -> do
      client.celestial_bodies.create({celestial_body: {"name" => "Mars", "type" => "terrestrial"}})
    end
  },
  {
    operation: "create",
