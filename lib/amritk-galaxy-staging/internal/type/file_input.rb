...
module DemoApiScalarGalaxy
  module Internal
    module Type
      ...
      # `DemoApiScalarGalaxy::Internal::Type::FileInput`.
      #
      ...
      class FileInput
        ...
        def self.===(other)
          case other
          in Pathname | StringIO | IO | String | DemoApiScalarGalaxy::FilePart
            true
          else
            false
          end
        ...
        #
        # @return [Boolean]
        def self.==(other) = other.is_a?(Class) && other <= DemoApiScalarGalaxy::Internal::Type::FileInput
        ...
        class << self
          ...
          def dump(value, state:)
            ...
            in StringIO | String
              ...
              DemoApiScalarGalaxy::FilePart.new(value, filename: "upload")
            in IO
              state[:can_retry] = false
              value.to_path.nil? ? DemoApiScalarGalaxy::FilePart.new(value, filename: "upload") : value
            in DemoApiScalarGalaxy::FilePart if value.content.is_a?(IO)
              state[:can_retry] = false
              value
            else
              value
