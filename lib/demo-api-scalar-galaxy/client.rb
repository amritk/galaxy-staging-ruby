...
module DemoApiScalarGalaxy
  class Client < DemoApiScalarGalaxy::Internal::Transport::BaseClient
    ...
    # @return [DemoApiScalarGalaxy::Resources::Planets]
    attr_reader :planets

    # Celestial bodies are the planets and satellites in the Scalar Galaxy.
    # @return [DemoApiScalarGalaxy::Resources::CelestialBodies]
    ...
    # @return [DemoApiScalarGalaxy::Resources::Authentication]
    attr_reader :authentication

    # @return [DemoApiScalarGalaxy::Resources::Webhooks]
    ...
    #
    # @param o_auth2 [String, nil] OAuth 2.0 authentication Defaults to `ENV["O_AUTH2"]`
    #
    # @param open_id_connect [String, nil] OpenID Connect Authentication Defaults to `ENV["OPEN_ID_CONNECT"]`
    #
    ...
    #
    # @param environment [:production, :responds_with_your_request_data, nil] Specifies the environment to use for the API.
    #
    ...
    def initialize(
      ...
      base_url ||=
        DemoApiScalarGalaxy::Client::ENVIRONMENTS.fetch(environment&.to_sym || :production) do
          message =
            "environment must be one of #{DemoApiScalarGalaxy::Client::ENVIRONMENTS.keys}, got #{environment}"
          raise ArgumentError.new(message)
        end

      headers = {}
      custom_headers_env = ENV["OFFICIAL_GALAXY_TESTING_CUSTOM_HEADERS"]
      ...
      @planets = DemoApiScalarGalaxy::Resources::Planets.new(client: self)
      @celestial_bodies = DemoApiScalarGalaxy::Resources::CelestialBodies.new(client: self)
      @authentication = DemoApiScalarGalaxy::Resources::Authentication.new(client: self)
      @webhooks = DemoApiScalarGalaxy::Resources::Webhooks.new(client: self)
    end
  end
end
