      ...
      class PooledNetRequester
        ...
        class << self
          ...
          def calibrate_socket_timeout(conn, deadline)
            timeout = deadline - DemoApiScalarGalaxy::Internal::Util.monotonic_secs
          ...
          def build_request(request, &blk)
            ...
            in String
              ...
              req.body_stream = DemoApiScalarGalaxy::Internal::Util::ReadIOAdapter.new(body, &blk)
            in StringIO
        ...
        private def with_pool(url, deadline:, &blk)
          origin = DemoApiScalarGalaxy::Internal::Util.uri_origin(url)
          timeout = deadline - DemoApiScalarGalaxy::Internal::Util.monotonic_secs
          pool =
        ...
        def execute(request)
          ...
          enum =
            Enumerator.new do |y|
                ...
                ::Thread.handle_interrupt(Object => :never) do
                  ::Thread.handle_interrupt(Object => :immediate) do
                    req, closing =
                      self
                      .class
                      .build_request(request) { self.class.calibrate_socket_timeout(conn, deadline) }
              ...
              raise DemoApiScalarGalaxy::Errors::APITimeoutError.new(url: url, request: req)
            rescue StandardError
              raise DemoApiScalarGalaxy::Errors::APIConnectionError.new(url: url, request: req)
            end
          # rubocop:enable Metrics/BlockLength

          _, response = enum.next
          body =
            DemoApiScalarGalaxy::Internal::Util.fused_enum(enum, external: true) do
              finished = true
              loop { enum.next }
            end
