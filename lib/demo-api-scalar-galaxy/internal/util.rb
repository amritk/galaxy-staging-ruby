    ...
    module Util
      ...
      class << self
        ...
        def coerce_hash!(input)
          ...
          in Hash | nil => coerced
            ...
            message =
              "Expected a #{Hash} or #{DemoApiScalarGalaxy::Internal::Type::BaseModel}, got #{input.inspect}"
      ...
      class << self
        ...
        def deep_merge(*values, sentinel: nil, concat: false)
          case values
          in [value, *values]
            values.reduce(value) { |acc, val| deep_merge_lr(acc, val, concat: concat) }
          else
            sentinel
          end
        end
      ...
      class << self
        ...
        def encode_path(path)
          path
            .to_s
            .gsub(DemoApiScalarGalaxy::Internal::Util::RFC_3986_NOT_PCHARS) { ERB::Util.url_encode(_1) }
        end
      ...
      class << self
        ...
        private def write_query_param_element!(collection, key, element)
          case element
          in Hash
            element.each { |name, value| write_query_param_element!(collection, "#{key}[#{name}]", value) }
          in Array
        ...
        private def write_multipart_content(y, val:, closing:, content_type: nil)
          ...
          case val
          in DemoApiScalarGalaxy::FilePart
            return (
              write_multipart_content(y, val: val.content, closing: closing, content_type: val.content_type)
            )
          in Pathname
        ...
        private def write_multipart_chunk(y, boundary:, key:, val:, closing:)
          ...
          y << "; name=\"#{key}\"" unless key.nil?

          case val
          in DemoApiScalarGalaxy::FilePart unless val.filename.nil?
            ...
            writable_enum do |y|
              ...
              in Hash
                body.each do |key, val|
                  case val
                  in Array if val.all? {
                    primitive?(_1) || DemoApiScalarGalaxy::Internal::Type::FileInput === _1
                  }
                    val.each do |v|
        ...
        def encode_content(headers, body)
          ...
          in [DemoApiScalarGalaxy::Internal::Util::JSON_CONTENT, Hash | Array | -> { primitive?(_1) }]
            [headers, JSON.generate(body)]
          in [
               DemoApiScalarGalaxy::Internal::Util::JSONL_CONTENT,
               Enumerable
             ] unless DemoApiScalarGalaxy::Internal::Type::FileInput === body
            [headers, body.lazy.map { JSON.generate(_1) }]
          in [%r{^multipart/form-data}, Hash | DemoApiScalarGalaxy::Internal::Type::FileInput]
          ...
          in [_, StringIO]
            [headers, body.string]
          in [_, DemoApiScalarGalaxy::FilePart]
        ...
        def decode_content(headers, stream:, suppress_error: false)
          ...
          in DemoApiScalarGalaxy::Internal::Util::JSON_CONTENT
          ...
          in DemoApiScalarGalaxy::Internal::Util::JSONL_CONTENT
        ...
        def fused_enum(enum, external: false, &close)
          ...
          iter =
            Enumerator.new do |y|
              ...
              fused = true
              external ? loop { y << enum.next } : enum.each(&y)
            ensure
              close&.call
              close = nil
            end
      ...
      module SorbetRuntimeSupport
        ...
        class << self
          # @api private
          #
          # @param type [DemoApiScalarGalaxy::Internal::Util::SorbetRuntimeSupport, Object]
          #
          # @return [Object]
          def to_sorbet_type(type)
            case type
            in DemoApiScalarGalaxy::Internal::Util::SorbetRuntimeSupport
              type.to_sorbet_type
            in Class | Module
              type
            in true | false
