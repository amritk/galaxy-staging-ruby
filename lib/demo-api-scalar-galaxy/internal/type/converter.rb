    ...
    module Type
      ...
      module Converter
        ...
        def dump(value, state:)
          case value
          in Array
            value.map { DemoApiScalarGalaxy::Internal::Type::Unknown.dump(_1, state: state) }
          in Hash
            value.transform_values { DemoApiScalarGalaxy::Internal::Type::Unknown.dump(_1, state: state) }
          ...
          in Pathname | IO
            ...
            DemoApiScalarGalaxy::FilePart.new(value)
        ...
        class << self
          ...
          def type_info(spec)
            ...
            in true | false
              -> { DemoApiScalarGalaxy::Internal::Type::Boolean }
            in DemoApiScalarGalaxy::Internal::Type::Converter | Class | Symbol
              -> { spec }
          ...
          #
          # @param target [DemoApiScalarGalaxy::Internal::Type::Converter, Class]
          #
          # @param value [Object]
          #
          ...
          #
          # @return [Object]
          def coerce(target, value, state: DemoApiScalarGalaxy::Internal::Type::Converter.new_coerce_state)
            # rubocop:disable Metrics/BlockNesting
            exactness = state.fetch(:exactness)

            case target
            in DemoApiScalarGalaxy::Internal::Type::Converter
          ...
          def dump(target, value, state: {can_retry: true})
            ...
            in DemoApiScalarGalaxy::Internal::Type::Converter
              ...
              DemoApiScalarGalaxy::Internal::Type::Unknown.dump(value, state: state)
            end
          end
        ...
        define_sorbet_constant!(:Input) do
          T.type_alias { T.any(DemoApiScalarGalaxy::Internal::Type::Converter, T::Class[T.anything]) }
        end
        ...
        define_sorbet_constant!(:DumpState) { T.type_alias { {can_retry: T::Boolean} } }
      end
    end
  end
end
